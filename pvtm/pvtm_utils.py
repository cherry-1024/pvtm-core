...
def popularity_based_prefiltering(data, args, min_df=0.05, max_df=0.95):
    """popularity based pre-filtering. Ignore rare and common words. And we don't want stopwords and digits. Takes a list of strings as input."""
...
def get_topics(objects, stopwords, num_words=15):
    """ Returns the most common words found in the documents which belong to a specific topic. """
